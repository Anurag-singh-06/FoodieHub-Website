...
import upiicon from '../img-visa/upi.svg';
import phonepeicon from "../img-visa/phonepe-logo-icon (1).svg";
...
const UpiPaymentOptions = () => {
  ...
  return (
    <div className="upi-container">
      ...
      <div className="payment-method" onClick={() => handlePaymentMethodClick('enterUPI')}>
        <input type="radio" className="check" checked={selectedMethod === 'enterUPI'} readOnly />
